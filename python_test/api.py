...
class PetFriends:
    ...
    def post_new_pet_with_photo(self, auth_key: json, name: str, animal_type: str, age: int, pet_photo: str):
    ...
    def post_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str, age: int):
    ...
    def delete_pet_by_pet_id(self, auth_key:json, pet_id:str):
        headers = {'auth_key': auth_key['key']}
    ...
    def put_update_info_pet(self, auth_key: json, pet_id: str, name: str, animal_type: str, age: int):
